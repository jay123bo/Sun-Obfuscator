	...
	const handleEditorDidMount = (editor: any, monaco: any) => {
		...
		monaco.editor.defineTheme("lua-obfuscator-dark", {
			...
			rules: [
				...
				{ token: "keyword", foreground: "8FB7D9", fontStyle: "bold" },
				{ token: "string", foreground: "A8C69F" },
				{ token: "number", foreground: "D8B26E" },
				{ token: "function", foreground: "A9C4E4" },
				{ token: "variable", foreground: "E6E9ED" },
				{ token: "identifier", foreground: "D5D9E0" },
				{ token: "operator", foreground: "B8A6D9" },
				{ token: "delimiter", foreground: "9EA7B3" },
			],
			colors: {
				"editor.background": "#111827", // Transparent to show gradient
